...
echo "NOTE: QML/C++ edits are only picked up after a shell restart"
echo "  (omarchy-restart-shell) or re-login - the plugin watcher does not"
echo "  re-parse entry QML. rescanPlugins only notices newly added plugin dirs."